      ...
      <div className='p-4 sm:p-10 flex flex-col-reverse md:grid md:grid-cols-2 gap-10 md:px-36'>
        ...
        <div className='text-gray-800'>
          ...
          <div className='flex items-center gap-2 py-3 mt-10'>
            ...
            <Rating initialRating={initalRating} onRate={handleRate}/>
          </div>
          ...
          {playerData ? (
            <div>
              ...
              <div className='flex justify-between items-center mt-1'>
                ...
                <button onClick={()=>markLectureAsCompleted(playerData.lectureId)} className='text-blue-600'>{progressData && progressData.lectureCompleted.includes(playerData.lectureId) ? 'Completed':'Mark Complete'}</button> I
              </div>
            </div>
          )
            :
